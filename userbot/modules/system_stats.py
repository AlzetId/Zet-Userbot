...
async def amireallyalive(alive):
    ...
    output = (
        f"**[𝚉𝙴𝚃-𝚄𝚂𝙴𝚁𝙱𝙾𝚃](https://github.com/AlzetId/Zet-Userbot)ㅤ𝚄𝙳𝙰𝙷 𝙰𝙺𝚃𝙸𝙵 𝚃𝙾𝙳.**\n\n"
        f"**{alive_text}**\n\n"
        f"╭✠╼━━━━━━━━━━━━━━━✠╮\n"
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n\n"
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/{Alzetsupport})** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/{chzetnih})** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={user.id})**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
